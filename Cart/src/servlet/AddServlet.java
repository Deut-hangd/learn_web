...
public class AddServlet extends HttpServlet{
    public void doGet(HttpServletRequest request,
        ...
        String demandNumber1 = request.getParameter("demandNumber");
        int demandNumber;
        //判定用户输入是否合法
        if (demandNumber1 == ""){
            demandNumber = 0;
        }else{
            demandNumber = Integer.valueOf(demandNumber1);
        }
        ...
        if (goodsId != null) {
            ...
            String strGoodsName = URLEncoder.encode(goods.getGoodsName(),"UTF-8");
