...
public class RemoveServlet extends HttpServlet{
    public void doGet(HttpServletRequest request,
        ...
        String removeNumber1 = request.getParameter("removeNumber");
        int removeNumber;
        if (removeNumber1 == " "){
            removeNumber = 0;
        }else{
            removeNumber = Integer.valueOf(removeNumber1).intValue();
        }
        ...
        if (goods != null && flag1){
            ...
            if (goods1 != null && flag2){
                ...
                mall.put(goods1.getGoodsId(),goods1);  //将更新过的商品信息插入商品清单
                application.setAttribute("MALL",mall);  //将更新过的商品清单插入application
                try {
                    gDao.updateGoods(goods1);  //更新数据库中的商品信息
                }catch (Exception e){
                    e.printStackTrace();
                }
            }
